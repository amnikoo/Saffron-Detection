...
def check_args(parsed_args):
    ...
    if parsed_args.gpu and 4 < len(parsed_args.gpu.split(',')):
        raise ValueError(
            "Batch size ({}) must be equal to or higher than the number of GPUs ({})".format(4,
...
def main(args=None):
    ...
    model.load_weights('unlabeled_model_2_full.h5', by_name=True)
